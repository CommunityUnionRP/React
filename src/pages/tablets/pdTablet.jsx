                    ...
                    <div className="imurfather">
                        ...
                        <div>
                            <div className="pageB">
                                ...
                                <div className="buttons_nav">
                                <button onClick={() => this.handleClickReturnB('pageB', pageB.step)} className="back focus" style={{float: 'left'}}>Назад</button>
                                    <button className="exitbutton focus" onClick={() => this.handleOnClickEB('', 'exit')} style={{float: 'right'}}>Выход</button>
                                </div>
                            </div>
                        </div> : ''}
                        {PDPage === 'C' ?
                        ...
                        <div>
                            <div className="pageD">
                                ...
                                <div className="buttons_nav">
                                    <button onClick={() => this.handleClickReturnD('pageD', pageD.step)} className="back focus" style={{float: 'left'}}>Назад</button>
                                    <button className="exitbutton focus" onClick={() => this.handleOnClickED('', 'exit')} style={{float: 'right'}}>Выход</button>
                                </div>
                            </div>
                        </div> : ''}
                        {PDPage === 'E' ?
                        <div>
                            <div className="pageD">
                                ...
                                <div className="buttons_nav">
                                    <button onClick={() => this.handleClickReturnE('pageE', pageE.step)} className="back focus" style={{float: 'left'}}>Назад</button>
                                    <button className="exitbutton focus" onClick={() => this.handleOnClickE('', 'exit')} style={{float: 'right'}}>Выход</button>
                                </div>
                            </div>
                        </div> : ''}
                        {PDPage === 'F' ?
                        <div>
                            <div class="pageF">
                                ...
                                <div class="buttons">
                                    ...
                                    <button onClick={() => this.callHelp('callHospitalHelp')}>НАРЯД МЕДИКОВ</button>
                                </div>
                                <div class="beDown">
                                ...
                                <div class="buttons_nav">
                                    <button class="back focus" onClick={() => this.handleOnClickD('A', 'page')} style={{float: 'left'}}>Назад</button>
                                    <button class="exitbutton focus" onClick={() => this.handleOnClickD('', 'exit')} style={{float: 'right'}}>Выход</button>
                                </div>
                            </div>
                        </div>  : ''}
                        {PDPage === 'G' ?
                        <div>
                            <div class="pageG">
                                <div class="calls">
                                    <div class="calls_overflow">
                                        ...
                                        <div>
                                            ...
                                            <div class="call">
                                                <div class="color">Вызов от:</div> 
                                                {item.name}
                                                <div class="color">Расстояние:</div> 
                                                TO DO
                                                <div class="color">Сообщение:</div> 
                                                {item.message}
                                                <button onClick={() => this.removeCall(item.id)} class="getcall">Принять вызов</button>
                                            </div> 
                                            )}
                                        </div> : 
                                        <div>
                                ...
                                <div class="buttons_nav">
                                    <button class="exitbutton focus" onClick={() => this.handleOnClickD('A', 'page')} style={{float: 'right'}}>Назад</button>
                                </div>
                            </div>
                        </div> : null}
                    </div>
