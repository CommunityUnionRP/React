                    ...
                    <div className="imurfather">
                        ...
                        <div>
                            <div className="calls">
                                ...
                                {this.state.calls.length !== 0 ?
                                    <div>
                                        ...
                                        <div className="call">
                                            <div className="color">Вызов от:</div>
                                            {item.name}
                                            <div className="color">Расстояние:</div>
                                            {parseInt(item.dist)} метров
                                            <div className="color">Сообщение:</div>
                                            {item.message}
                                            <button onClick={() => this.removeCall(item.id, item.pos.x, item.pos.y)} className="getcall">Принять вызов</button>
                                            </div>
                                        )}
                                    </div> :
                                    <div>
                            ...
                            <div className="map">
                                ...
                                <div className="buttons_nav">
                                    <button onClick={() => this.handleOnClick('A', 'page')} className="exitbutton focus">Назад</button>
                                </div>
                            </div>
                        </div> : null}
