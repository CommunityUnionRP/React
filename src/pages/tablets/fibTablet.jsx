                    ...
                    <div className="imurfather">
                        ...
                        <div className="pageC">
                            ...
                            <div onClick={() => this.handleOnClick('A', 'page')} className="buttons_nav">
                                <button className="back focus" style={{float: 'left'}}>Назад</button>
                                <button className="exitbutton focus" style={{float: 'right'}}>Выход</button>
                            </div>
                        </div> : ''}
                        {FIBPage === 'D' ?
                        <div>
                        ...
                        <div class="pageF">
                            ...
                            <div onClick={() => this.handleOnClickD('A', 'page')} class="buttons_nav">
                                <button class="back focus" style={{float: 'left'}}>Назад</button>
                                <button class="exitbutton focus" style={{float: 'right'}}>Выход</button>
                            </div>
                        </div> : ''}
                        {FIBPage === 'G' ?
                        <div class="pageG">
                            ...
                            <div onClick={() => this.handleOnClickD('A', 'page')} class="buttons_nav">
                                <button class="exitbutton focus" style={{float: 'right'}}>Назад</button>
                            </div>
                        </div> : ''}
                    </div>
                </div>
